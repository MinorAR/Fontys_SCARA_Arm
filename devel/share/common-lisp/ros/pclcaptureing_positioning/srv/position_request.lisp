...
(cl:in-package pclcaptureing_positioning-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <position_request-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'position_request-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pclcaptureing_positioning-srv:<position_request-request> is deprecated: use pclcaptureing_positioning-srv:position_request-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <position_request-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pclcaptureing_positioning-srv:pose-val is deprecated.  Use pclcaptureing_positioning-srv:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<position_request-request>)))
  ...
  "pclcaptureing_positioning/position_requestRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'position_request-request)))
  "Returns string type for a service object of type 'position_request-request"
  "pclcaptureing_positioning/position_requestRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <position_request-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'position_request-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pclcaptureing_positioning-srv:<position_request-response> is deprecated: use pclcaptureing_positioning-srv:position_request-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <position_request-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pclcaptureing_positioning-srv:success-val is deprecated.  Use pclcaptureing_positioning-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<position_request-response>)))
  ...
  "pclcaptureing_positioning/position_requestResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'position_request-response)))
  "Returns string type for a service object of type 'position_request-response"
  "pclcaptureing_positioning/position_requestResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'position_request)))
  ...
  "pclcaptureing_positioning/position_request")